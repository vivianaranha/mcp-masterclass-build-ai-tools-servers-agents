...
**Module:** MCP Authorization Hardening — 2026

## Objective
Understand and implement **client metadata documents vs dcr** as part of a production MCP system.
...
Authorization hardening includes issuer validation and credential isolation. Treat authorization metadata as security-critical application state.

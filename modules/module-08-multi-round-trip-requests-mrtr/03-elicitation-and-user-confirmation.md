...
**Module:** Multi Round-Trip Requests (MRTR)

## Objective
Understand and implement **elicitation and user confirmation** as part of a production MCP system.
...
MRTR lets a server request missing input or confirmation while processing a request, without restoring a persistent bidirectional session.

...
**Module:** MCP Tasks Extension

## Objective
Understand and implement **task handles and server-directed creation** as part of a production MCP system.
...
Tasks are an extension. The server decides when a request materializes as a task, while the client polls or updates/cancels that task.

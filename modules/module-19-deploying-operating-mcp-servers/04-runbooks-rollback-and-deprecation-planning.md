...
**Module:** Deploying & Operating MCP Servers

## Objective
Understand and implement **runbooks, rollback and deprecation planning** as part of a production MCP system.
...
MCP now has a formal deprecation policy. Production teams should track protocol and SDK versions rather than silently carrying legacy session/SSE assumptions forever.
